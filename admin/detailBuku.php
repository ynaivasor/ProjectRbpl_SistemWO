...
<main>
  <div class="card">
    <form method="POST" action="listBukuRantaman.php" enctype="multipart/form-data">

      <!-- ROW 1: Nama Pengantin -->
      <div class="form-grid-2">
        <div class="form-group">
          <label for="nama_pengantin_pria">Nama Pengantin Pria</label>
        <input
  type="text"
...
/>
     ...
     Lihat File Rancangan
      ...
      <div class="btn-submit-wrap">
        <button type="submit" name="kembaliMenu" class="btn-submit">
          Kembali
        </button>
      </div>
